...
role :web, "50.57.191.55" # Your HTTP server, Apache/etc
role :app, "50.57.191.55" # This may be the same as your `Web` server
role :db, "50.57.191.55", :primary => true # This is where Rails migrations will run

set :application, "loja"
set :repository, "git@github.com:alcelyo/linuxfi-loja.git"
set :scm, :git
set :use_sudo, false
